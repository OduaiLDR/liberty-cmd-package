...
@section('content')
    <div class="card">
        <div class="card-header d-flex align-items-center py-0">
            <h6 class="py-3 mb-0">List of NSF Orders</h6>
        </div>
        <div class="card-body">
            <form method="get" action="{{ route('cmd.reports.nsf_report') }}" class="bg-light rounded-3 p-2 p-md-3 mb-3"
                id="nsf-report-form">
                ...
                <div class="row g-2 align-items-center">
                    <div class="cg-2 align-items-center justify-content-end">
                        <span class="fw-semibold">NSF Orders For :</span>
                    </div>
                    ...
                    <div class="row g-2 mt-2">
                        ...
                        <div class="col-md-2">
                            ...
                            <select name="company" class="form-select form-select-sm">
                                ...
                                <option value="progress" {{ request('company') === 'progress' ? 'selected' : '' }}>Progress
                                    Law</option>
                ...
                <div class="col-auto">
                    <div class="d-flex gap-2 justify-content-end">
                        ...
                        <a href="{{ route('cmd.reports.nsf_report') }}" class="btn btn-light btn-sm">Reset</a>
                        <div class="col-auto">
                ...
                <table class="table">
                    <thead>
                        <tr>
                            ...
                            <th class="text-start">Program Payment</th>
                    ...
                    <tbody>
                        @forelse ($reports as $report)
                            <tr>
                                ...
                                <td class="text-start">{{ $formatMoney($report->Program_Payment) }}</td>
...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            (function() {
                const form = document.getElementById('nsf-report-form');
                if (!form) return;
