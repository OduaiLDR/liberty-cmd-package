...
final class CmdReportPermissions
{
	...
	'cmd.reports.uncleared_settlement_payments_report',
        ...
        'cmd.reports.agent_summary_report',
        'cmd.reports.sales_admin_report',
        'cmd.reports.settlement_admin_report',
        'cmd.reports.sales_manager_commission_report',
        'cmd.reports.sales_team_leader_commission_report',
        'cmd.reports.training_report',
        'cmd.reports.leaderboard_report',
        'cmd.reports.invoice_report',
