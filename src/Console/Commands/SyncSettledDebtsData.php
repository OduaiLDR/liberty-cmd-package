...
SELECT
    d.ID AS DEBT_ID,
    TO_CHAR(CONVERT_TIMEZONE('America/Los_Angeles', d.SETTLEMENT_DATE), 'YYYY-MM-DD HH24:MI:SS') AS SETTLEMENT_DATE,
    TO_CHAR(CONVERT_TIMEZONE('America/Los_Angeles', d.LAST_PAYMENT), 'YYYY-MM-DD HH24:MI:SS') AS LAST_PAYMENT,
    d.ACCOUNT_NUM,
