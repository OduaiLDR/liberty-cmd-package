...
SELECT
    ...
    TO_VARCHAR(CONVERT_TIMEZONE('America/Los_Angeles', RETURNED_DATE), 'YYYY-MM-DD') AS RETURNED_DATE,
    RETURN_CODE
FROM (
    SELECT
        t.CONTACT_ID,
        ...
        t.RETURN_CODE,
        ROW_NUMBER() OVER (PARTITION BY t.CONTACT_ID ORDER BY CONVERT_TIMEZONE('America/Los_Angeles', t.PROCESS_DATE) ASC) AS N
    FROM TRANSACTIONS t
