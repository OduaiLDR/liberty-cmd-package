...
use Carbon\Carbon;
use Cmd\Reports\Http\Requests\CapitalReportRequest;
use Cmd\Reports\Repositories\CapitalReportRepository;
...
class CapitalReportController extends Controller
{
    ...
    public function __construct(
        protected CapitalReportRepository $repository
    ) {
    }

    public function index(CapitalReportRequest $request): View|StreamedResponse
    {
        ...
        return view('reports::reports.capital', [
            'reports' => $reports,
    ...
    {
        return str_contains(strtolower($key), 'date');
    }
    ...
    {
        $filename = 'capital_report_' . Carbon::now()->format('Ymd_His') . '.csv';
        $headers = [
