...
use Carbon\Carbon;
use Cmd\Reports\Http\Requests\SalesManagerCommissionReportRequest;
use Cmd\Reports\Repositories\SalesManagerCommissionReportRepository;
...
class SalesManagerCommissionReportController extends Controller
{
    use CsvFormatting;

    public function __construct(
        protected SalesManagerCommissionReportRepository $repository
    ) {
    }

    public function index(SalesManagerCommissionReportRequest $request): View|StreamedResponse
    {
        ...
        return view('reports::reports.sales_manager_commission', [
            'reports' => $reports,
    ...
    {
        $filename = 'sales_manager_commission_' . Carbon::now()->format('Ymd_His') . '.csv';
        $headers = [
