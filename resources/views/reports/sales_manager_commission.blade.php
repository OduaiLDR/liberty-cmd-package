...
@section('content')
    ...
    <div class="card">
        <div class="card-header d-flex align-items-center py-0">
            <h6 class="py-3 mb-0">Sales Manager Commission Report</h6>
        </div>
        <div class="card-body">
            <form method="get" action="{{ route('cmd.reports.sales_manager_commission_report') }}" class="bg-light rounded-3 p-2 p-md-3 mb-3" id="sales-manager-commission-form">
    ...
    <script>
        function clearFilters() {
            const form = document.getElementById('sales-manager-commission-form');
