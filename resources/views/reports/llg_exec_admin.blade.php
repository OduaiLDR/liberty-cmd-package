...
@section('content')
    ...
    <div class="card">
        <div class="card-header d-flex align-items-center py-0">
            <h6 class="py-3 mb-0">LLG Exec Admin Report</h6>
        </div>
        <div class="card-body">
            <form method="get" action="{{ route('cmd.reports.llg_exec_admin_report') }}" class="bg-light rounded-3 p-2 p-md-3 mb-3" id="llg-exec-admin-form">
                ...
                <div class="row g-2 align-items-center">
                    <div class="cg-2 align-items-center justify-content-end">
                        <span class="fw-semibold">LLG Exec Admin For :</span>
                    </div>
                ...
                <details class="mt-2 mb-2">
                    ...
                    <div class="row g-2 mt-2">
                        ...
                        <div class="col-md-3">
                            <label class="form-label form-label-sm">Source (contains)</label>
                            <input type="text" name="source" value="{{ request('source') }}" class="form-control form-control-sm" autocomplete="off">
                        </div>
                        <div class="col-md-3">
                            <label class="form-label form-label-sm">Employee Name (contains)</label>
                            <input type="text" name="employee_name" value="{{ request('employee_name') }}" class="form-control form-control-sm" autocomplete="off">
                        </div>
                        <div class="col-md-3">
                            <label class="form-label form-label-sm">Payment Type (contains)</label>
                            <input type="text" name="payment_type" value="{{ request('payment_type') }}" class="form-control form-control-sm" autocomplete="off">
                        </div>
                    </div>
                </details>
                ...
                <div class="col-auto">
                    <div class="d-flex gap-2 justify-content-end">
                        ...
                        <a href="{{ route('cmd.reports.llg_exec_admin_report') }}" class="btn btn-light btn-sm">Reset</a>
                        <div class="col-auto">
            ...
            @php
                // Calculate summary totals from current page
                $totalLoanAmount = 0;
                $totalCommission = 0;
                foreach ($reports as $report) {
                    $totalLoanAmount += (float) ($report->loan_amount ?? 0);
            ...
            <div class="alert alert-warning mb-3">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <strong>Total Loan Amount:</strong> {{ $fmtMoney($totalLoanAmount) }}
                    </div>
                    <div class="col-md-4">
                        <strong>Total Commission:</strong> {{ $fmtMoney($totalCommission) }}
                    </div>
                </div>
            </div>
                ...
                <table class="table table-striped table-bordered align-middle">
                    ...
                    <tbody>
                        <tr class="table-warning fw-bold">
                            ...
                            <td>-</td>
                            <td>-</td>
                            <td class="text-end">{{ $fmtMoney($totalLoanAmount) }}</td>
...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            const form = document.getElementById('llg-exec-admin-form');
            if (!form) return;
