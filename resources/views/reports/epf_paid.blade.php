...
@section('content')
    ...
    <div class="card">
        <div class="card-header d-flex align-items-center py-0">
            <h6 class="py-3 mb-0">EPF Paid</h6>
        </div>
        <div class="card-body">
            <form method="get" action="{{ route('cmd.reports.epf_paid_report') }}" class="bg-light rounded-3 p-2 p-md-3 mb-3" id="epf-paid-form">
                ...
                <div class="row g-2 align-items-center">
                    <div class="cg-2 align-items-center justify-content-end">
                        <span class="fw-semibold">EPF Paid For :</span>
                    </div>
                ...
                <div class="col-auto">
                    <div class="d-flex gap-2 justify-content-end">
                        ...
                        <a href="{{ route('cmd.reports.epf_paid_report') }}" class="btn btn-light btn-sm">Reset</a>
                        <div class="col-auto">
...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            const form = document.getElementById('epf-paid-form');
            if (!form) return;
